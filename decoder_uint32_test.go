...
func TestDecoderUint32FromUint8(t *testing.T) {
	...
	for testNumber, test := range tests {
		...
		x, err := decoder.Uint32(targetKey)
		if nil != err {
...
func TestDecoderUint32FromUint16(t *testing.T) {
...
func TestDecoderUint32FromUint32(t *testing.T) {
