...
func TestDecoderUint64FromUint8(t *testing.T) {
	...
	for testNumber, test := range tests {
		...
		x, err := decoder.Uint64(targetKey)
		if nil != err {
...
func TestDecoderUint64FromUint16(t *testing.T) {
...
func TestDecoderUint64FromUint32(t *testing.T) {
...
func TestDecoderUint64FromUint64(t *testing.T) {
