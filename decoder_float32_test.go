...
func TestDecoderFloat32FromFloat32(t *testing.T) {
	...
	for testNumber, test := range tests {
		...
		x, err := decoder.Float32(targetKey)
		if nil != err {
...
func TestDecoderFloat32FromInt8(t *testing.T) {
...
func TestDecoderFloat32FromInt16(t *testing.T) {
...
func TestDecoderFloat32FromUint8(t *testing.T) {
...
func TestDecoderFloat32FromUint16(t *testing.T) {
